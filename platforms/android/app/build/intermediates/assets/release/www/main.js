...
var map = {
	...
	"./pages/infos-expo/infos-expo.module": [
		"./src/app/pages/infos-expo/infos-expo.module.ts",
		"pages-infos-expo-infos-expo-module"
	],
	"./pages/view-expo/view-expo.module": [
...
/* harmony import */ var _providers_expos_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./providers/expos.service */ "./src/app/providers/expos.service.ts");
/* harmony import */ var _notifications_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./notifications.service */ "./src/app/notifications.service.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                ...
                _providers_expos_service__WEBPACK_IMPORTED_MODULE_7__["ExposService"],
...
var NotificationsService = /** @class */ (function () {
    function NotificationsService(firebase, platform, afs) {
        this.firebase = firebase;
        this.platform = platform;
        this.afs = afs;
    }
    NotificationsService.prototype.getToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            var token;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    NotificationsService.prototype.saveToken = function (token) {
        if (!token)
            return;
    ...
    NotificationsService.prototype.onNotifications = function () {
...
/***/ "./src/app/providers/expos.service.ts":
/*!********************************************!*\
  !*** ./src/app/providers/expos.service.ts ***!
  \********************************************/
/*! exports provided: ExposService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExposService", function() { return ExposService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
...
var ExposService = /** @class */ (function () {
    function ExposService(platform) {
        this.platform = platform;
        this.db = firebase__WEBPACK_IMPORTED_MODULE_2__["firestore"]();
        var settings = { timestampsInSnapshots: true };
        this.db.settings(settings);
    }
    ExposService.prototype.getOneExpo = function (slug) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.db.collection("expos").where("slug", "==", slug)
    ...
    ExposService.prototype.getPages = function (expo) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.db.collection("expos").doc(expo.$key).collection("listpages").orderBy("order")
                .onSnapshot(function (querySnapshot) {
                var arr = [];
                querySnapshot.forEach(function (doc) {
                    var obj = JSON.parse(JSON.stringify(doc.data()));
    ...
    ExposService.prototype.getExpos = function (collection) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.db.collection(collection).where("valide", "==", true)
                .onSnapshot(function (querySnapshot) {
                var arr = [];
                querySnapshot.forEach(function (doc) {
                    var obj = JSON.parse(JSON.stringify(doc.data()));
    ...
    ExposService.prototype.getCurrentExpo = function () {
        return this.currentExpo;
    };
    ExposService.prototype.setCurrentExpo = function (expo) {
        this.currentExpo = expo;
    };
    ExposService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["Platform"]])
...
module.exports = __webpack_require__(/*! /home/fabien/compagnonbml/src/main.ts */"./src/main.ts");
